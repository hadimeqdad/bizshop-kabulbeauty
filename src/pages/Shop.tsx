...
const Shop = () => {
  ...
  return (
    <>
        <SEO
  title="خرید آنلاین دمنوش، محصولات آرایشی و بهداشتی در کابل | بیزشاپ"
  description="خرید آنلاین دمنوش، قهوه، محصولات آرایشی، بهداشتی و درمانی در کابل افغانستان. برندهای دکتر بیز، ستین، داینامین، بینه‌استار. تحویل سریع در کابل."
  keywords="خرید دمنوش کابل، خرید قهوه افغانستان، محصولات آرایشی کابل، خرید بهداشتی افغانستان، دکتر بیز، ستین، داینامین"
  jsonLd={{
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "فروشگاه بیزشاپ کابل",
    url: "https://bizshopkabul.com/shop",
